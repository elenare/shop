...
public class UserAgentProcessor implements Serializable {
    private static final long serialVersionUID = -4045110918981924097L;
    
    private UAgentInfo uAgentInfo;
    private HttpServletRequest request;                                //NOSONAR
     ...
     */
    @Inject
    UserAgentProcessor(HttpServletRequest request) {
        super();
